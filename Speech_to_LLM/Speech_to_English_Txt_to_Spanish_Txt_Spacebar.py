#!/usr/bin/env python3
"""
Spacebar-Controlled Speech Translation
Press and hold spacebar to record, release to process
...
def main():
    print("🎤 Spacebar-Controlled Speech Translation")
    print("=" * 50)
    ...
    print("Press SPACEBAR again to stop and translate")
